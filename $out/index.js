...
const uri = 'mongodb://localhost:27017/out-example';
...
await Product.aggregate([
  ...
  {
    $out: 'discounted_products' 
  }
]);

console.log('Data written to "discounted_products" collection');

const DiscountedProduct = mongoose.connection.collection('discounted_products');
const discountedData = await DiscountedProduct.find().toArray();
console.log('Discounted Products:', discountedData);
